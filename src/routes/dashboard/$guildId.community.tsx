...
import { GiveawaysManagerPanel } from "@/components/dashboard/giveaway-manager";
...
export const Route = createFileRoute("/dashboard/$guildId/community")({
  head: () => ({
    meta: [
      { title: "Community — ! HOY Control Center" },
      { name: "description", content: "Run reaction roles, advanced giveaways, polls and a starboard for your community." },
      { property: "og:title", content: "Community — ! HOY Control Center" },
      { property: "og:description", content: "Reaction roles, advanced giveaways, polls and starboard." },
    ],
  }),
  component: () => (
    <div>
