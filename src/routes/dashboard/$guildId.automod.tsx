...
export const Route = createFileRoute("/dashboard/$guildId/automod")({
  head: () => ({
    meta: [
      { title: "Auto Moderation — ! HOY BOT Control Center" },
      { name: "description", content: "Automatically block spam, invites, links and mass mentions in your server." },
      { property: "og:title", content: "Auto Moderation — ! HOY BOT Control Center" },
  ...
  component: () => (
    <div>
      <ModuleHeader
        ...
        description="Prevent spam, invites and other unwanted messages using ! HOY BOT's auto moderation."
      />
      <WithConfig>
