...
export const Route = createFileRoute("/dashboard/$guildId/errors")({
  head: () => ({
    meta: [
      { title: "Error log — ! HOY BOT Control Center" },
      { name: "description", content: "Every error ! HOY BOT has encountered for this server." },
    ],
  }),
        ...
        <div className="flex items-center gap-2">
          ...
          <div>
            ...
            <p className="text-sm text-muted-foreground">
              Every error ! HOY BOT has hit while running for this server — command failures, event
