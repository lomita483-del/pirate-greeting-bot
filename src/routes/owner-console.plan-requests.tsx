...
function PlanRequestsPage() {
  ...
  return <main className="mx-auto max-w-6xl space-y-6 px-6 py-8">
    <div><h1 className="flex items-center gap-2 text-3xl font-semibold"><Crown className="size-7 text-gold" /> Plan unlock requests</h1><p className="mt-2 text-sm text-muted-foreground">Accept or decline manual plan unlock requests. Approval immediately applies the selected plan features to the user's account.</p></div>
