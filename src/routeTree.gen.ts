...
const StatahoyIndexRoute = StatahoyIndexRouteImport.update({
  id: '/statahoy/',
  path: '/statahoy/',
  getParentRoute: () => rootRouteImport,
} as any)
const StatahoyGuildIdRoute = StatahoyGuildIdRouteImport.update({
  id: '/statahoy/$guildId',
  path: '/statahoy/$guildId',
  getParentRoute: () => rootRouteImport,
} as any)
...
const DashboardGuildIdRollCallRoute = DashboardGuildIdRollCallRouteImport.update({
  id: '/rollcall',
  path: '/rollcall',
  getParentRoute: () => DashboardGuildIdRoute,
} as any)
...
export interface FileRoutesByFullPath {
  ...
  '/dashboard/$guildId/rollcall': typeof DashboardGuildIdRollCallRoute
...
declare module '@tanstack/react-router' {
  interface FileRoutesByPath {
    ...
    '/statahoy/': {
      ...
      path: '/statahoy'
      fullPath: '/statahoy/'
      preLoaderRoute: typeof StatahoyIndexRouteImport
      parentRoute: typeof rootRouteImport
    }
    '/statahoy/$guildId': {
      id: '/statahoy/$guildId'
      path: '/statahoy/$guildId'
      fullPath: '/statahoy/$guildId'
      preLoaderRoute: typeof StatahoyGuildIdRouteImport
      parentRoute: typeof rootRouteImport
    }
    '/api/public/invite': {
      id: '/api/public/invite'
    ...
    '/dashboard/$guildId/rollcall': {
      id: '/dashboard/$guildId/rollcall'
      path: '/rollcall'
      fullPath: '/dashboard/$guildId/rollcall'
      preLoaderRoute: typeof DashboardGuildIdRollCallRouteImport
      parentRoute: typeof DashboardGuildIdRoute
    }
    '/dashboard/$guildId/send': {
...
const DashboardGuildIdRouteChildren: DashboardGuildIdRouteChildren = {
  ...
  DashboardGuildIdRollCallRoute: DashboardGuildIdRollCallRoute,
