...
export function SupportPanel() {
  ...
  const reports = useQuery({ queryKey: ["my-support-reports"], queryFn: getMySupportReports, refetchInterval: 5000, refetchIntervalInBackground: true });
