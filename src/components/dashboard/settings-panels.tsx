...
export function GeneralPanel({
  ...
  const channels =
    config.structure.channels.filter(
      (c) => c.kind === "text",
    );
  ...
  const form = useDraft(
    ...
    "general",
    {
      ...
      level_up_message:
        s?.level_up_message ??
        "Ahoy {user}, ye reached level {level}!",

      level_up_channel_id:
        s?.level_up_channel_id ??
        null,
      ...
      ticket_panel_channel_id:
        s?.ticket_panel_channel_id ??
        null,

      ticket_support_role_ids:
        s?.ticket_support_role_ids ??
        [],

      ticket_welcome_message:
        s?.ticket_welcome_message ??
        "Thanks for reaching out — the crew will be with you shortly.",

      ticket_transcripts_enabled:
        s?.ticket_transcripts_enabled ??
        true,

      ticket_transcript_channel_id:
        s?.ticket_transcript_channel_id ??
        null,

      ticket_dm_transcript_enabled:
        s?.ticket_dm_transcript_enabled ??
        false,
    },
    onSaved,
  );
    ...
    <div className="space-y-6">
        ...
        <CardContent className="space-y-5 pt-6">
          ...
          <div className="grid gap-5 md:grid-cols-2">
            ...
            <Field
              ...
              hint="Leave unset to reply in the active channel."
            >
              <PickerSelect
                value={
                  draft.level_up_channel_id
                }
                options={
                  channels
                }
            ...
            <Field
              ...
              hint="Placeholders: {user}, {level}"
            >
              <Input
                value={
                  draft.level_up_message
                }
                onChange={(e) =>
                  set(
                    "level_up_message",
      ...
      <Card className="glass border-0">
        <CardContent className="space-y-5 pt-6">
          <SectionHeader
            title="Economy"
            description="Daily rewards and starting balances."
          />

          <ToggleRow
            label="Enable economy"
            checked={
              draft.economy_enabled
            }
            onChange={(v) =>
              set(
                "economy_enabled",
      ...
      <Card className="glass border-0">
        <CardContent className="space-y-5 pt-6">
          <SectionHeader
            title="Tickets"
            description="Configure private support tickets, per-button routing, forms and transcripts."
          />

          <ToggleRow
            label="Enable tickets"
            checked={
              draft.tickets_enabled
            }
            onChange={(v) =>
              set(
                "tickets_enabled",
          ...
          >
            <MultiPicker
              values={
                draft.ticket_support_role_ids
              }
              options={
                config.structure.roles
              }
              onChange={(v) =>
                set(
                  "ticket_support_role_ids",
...
export function GoodbyePanel({
  ...
  const form = useDraft(
    ...
    "welcome",
    {
      ...
      goodbye_channel_id:
        w?.goodbye_channel_id ??
        null,

      goodbye_message:
        w?.goodbye_message ??
        "{user} has sailed off into the fog.",
    },
    onSaved,
  );
  ...
  [
    {
      ...
      events: [
        ...
        {
          key: "channel_name_update",
          label: "Channel Name Update",
        },
        {
          key: "channel_topic_update",
          label: "Channel Topic Update",
        },
        {
          key: "channel_nsfw_update",
          label: "Channel NSFW Update",
        },
        {
          key: "channel_parent_update",
          label: "Channel Category Update",
        },
        {
          key: "channel_slow_mode_update",
          label: "Channel Slow Mode Update",
        },
      ],
    },

    {
      ...
      events: [
        ...
        {
          key: "role_name_update",
          label: "Role Name Update",
        },
        {
          key: "role_color_update",
          label: "Role Color Update",
        },
        {
          key: "role_permissions_update",
          label: "Role Permissions Update",
        },
        {
          key: "role_hoist_update",
          label: "Role Hoist Update",
        },
        {
          key: "role_mentionable_update",
          label: "Role Mentionable Update",
        },
        {
          key: "role_position_update",
          label: "Role Position Update",
        },
      ],
    },
...

    {
      ...
      events: [
        ...
        {
          key: "user_roles_add",
          label: "User Roles Add",
        },
        {
          key: "user_roles_remove",
          label: "User Roles Remove",
        },
        {
...

    {
      ...
      events: [
        {
          key: "voice_user_join",
          label: "Voice User Join",
        },
        {
          key: "voice_user_leave",
          label: "Voice User Leave",
        },
        {
          key: "voice_user_switch",
          label: "Voice User Switch",
        },
      ],
    },

    {
      ...
      events: [
        {
          key: "server_name_update",
          label: "Server Name Update",
        },
        {
          key: "server_icon_update",
          label: "Server Icon Update",
        },
        {
          key: "server_owner_update",
          label: "Server Owner Update",
        },
        {
          key: "verification_level_update",
          label: "Verification Level Update",
        },
        {
          key: "server_boost_level_update",
          label: "Server Boost Level Update",
        },
      ],
    },
...

    {
      ...
      events: [
        ...
        {
          key: "thread_unarchive",
          label: "Thread Unarchive",
        },
        {
          key: "thread_lock",
          label: "Thread Lock",
        ...
        {
          key: "thread_name_update",
          label: "Thread Name Update",
        },
      ],
    },
...

    {
      ...
      events: [
        ...
        {
          key: "moderation_untimeout",
          label: "Timeout Remove",
        },
        {
          key: "moderation_automod",
...
export function LoggingPanel({
  ...
  const form = useDraft(
    ...
    "logging",
    {
      ...
      message_delete:
        l?.message_delete ?? true,

      message_edit:
        l?.message_edit ?? true,

      moderation_actions:
        l?.moderation_actions ??
        true,
...
export function AutoModPanel({
  ...
  const form = useDraft(
    ...
    "automod",
    {
      ...
      anti_spam_action:
        (a?.anti_spam_action ??
          "timeout") as ModAction,

      mention_limit_enabled:
        a?.mention_limit_enabled ??
        true,
        ...
        <CardContent className="space-y-5 pt-6">
          ...
          <div className="space-y-4 rounded-xl border border-border/70 p-4">
            <ToggleRow
              ...
              checked={
                draft.duplicate_filter_enabled
              }
              onChange={(v) =>
                set(
                  "duplicate_filter_enabled",
          ...
          <Field label="Ignored channels">
            <MultiPicker
              values={
                draft.ignored_channel_ids
              }
              options={config.structure.channels.filter(
                (c) =>
                  c.kind ===
                  "text",
              )}
